...
class animalsDAGANDataset(DAGANDataset):
    ...
    def load_dataset(self, gan_training_index):
        ...
        # self.x = np.load("./Augmentednpy/dataset_forclassifier/funit_samecategories_30.npy")
        # self.x = np.load("./Augmentednpy/dataset_forclassifier/funitsame10way_40.npy")
        # self.x = np.load("../Matching-DAGAN-1wayKshot/datasets/animals_3_100_3_100_data.npy")
        # self.x = np.load("./Augmentednpy/dataset_forclassifier/funitsame10way_40.npy")
        self.x = np.load("./Augmentednpy/dataset_forclassifier/funitsdif10way_450.npy")
        print('data shape', np.shape(self.x))
        self.x = self.x / 255
        x_train, x_val, x_test = self.x[:], self.x[:], self.x[:]
        return x_train, x_test, x_val
